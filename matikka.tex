...
% Kaavio 2: Joukon A komplementti (¬A)
...
\begin{tikzpicture}
	...
	% Komplementti A varjostettuna (¬A)
	\fill[blue!30] (0,0) circle (3.2);  % Täytä koko universumi ensin sinisellä
	\fill[white] (-1,0) circle (1.5);  % Täytä joukko A valkoisella
...
\vspace{1cm}  % Lisää väliä

% Kaavio 3: Leikkaus (A ∪ B) ∩ ¬A
\textbf{Leikkaus $(A \cup B) \cap \complement A$.}
...
\begin{tikzpicture}
	...
	\begin{scope}
		...
		\fill[white!30] (1,0) circle (1.5);  % Täytä joukko B (A ∪ B)
	\end{scope}
